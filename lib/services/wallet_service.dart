...
import 'package:ed25519_edwards/ed25519_edwards.dart' as ed; // or use web3dart logic
...
class WalletService {
  ...
  Future<Account> importFromPrivateKey(String privateKey, {String mnemonic = ''}) async {
    // Ensure PK format
